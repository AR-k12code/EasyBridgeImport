...
Import-Csv C:\scripts\importfiles\pearson_PIF_sections_student.csv `
  | select @{n="section_student_code";e={$_.section_student_code +"_"+ $_.date_start +"_" + $_.section +"_"+ $_.student_code +"_"+ $_.period}}, student_code, @{n="native_section_code";e={$_.native_section_code +"_"+ $_.date_start +"_" + $_.section +"_"+$_.period }}, school_year, date_start, date_end -ExcludeProperty section,period `
  | % {
...
#datestart ifs
    ...
    $_
  }  |export-csv -NoTypeInformation C:\scripts\importfiles\PIF_SECTION_STUDENT.txt